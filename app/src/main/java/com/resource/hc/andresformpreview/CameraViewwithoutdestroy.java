...
public class CameraViewwithoutdestroy extends Activity implements View.OnClickListener
{
    ...
    public void run() {
        try{
            ...
            cameraDevice.close();
            CameraViewwithoutdestroy.this.cameraDevice = null;
    ...
    private final CameraDevice.StateCallback stateCallback = new CameraDevice.StateCallback()
    {
        ...
        {
            CameraViewwithoutdestroy.this.cameraDevice = cameraDevice;
            // 开始预览
        ...
        public void onError(CameraDevice cameraDevice, int error)
        {
            ...
            CameraViewwithoutdestroy.this.finish();
        }
    };
        ...
        try
        {
            ...
            cameraDevice.createCaptureSession(Arrays.asList(imageReader.getSurface()),
                    new CameraCaptureSession.StateCallback() // ③
                    {
                        ...
                        {
                            Toast.makeText(CameraViewwithoutdestroy.this, "配置失败！"
